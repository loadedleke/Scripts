...
Get-item 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\{C6095BA2-96D7-478C-922F-01849BD21AFD}' | Remove-Item -Force -Verbose -ErrorAction SilentlyContinue
